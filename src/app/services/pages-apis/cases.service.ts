...
export class CasesService {
  ...
  getPathDetail(app, pro, task, s, l) {
    return this.api.commonGet({isToken : false, endPointUrl : this.endPoints.GET_PATH_DETAIL(app, pro , task, s, l), showLoading : false, showError : false});
  }
  getCalender() {
    return this.api.commonGet({isToken : false, endPointUrl : this.endPoints.CASE_SCHEDULE, showLoading : false, showError : true});
  }
  getCalenderSingle(form) {
    return this.api.commonPost(form, {isToken : false, endPointUrl : this.endPoints.CASE_SCHEDULE_SINGLE, showLoading : false, showError : true});
  }
}
