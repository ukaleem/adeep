...
export class EndpointsService {
  ...
  UPDATE_SCHEDULE =  ConfigService.SERVER_ADDRESS + '/api/1.0/' + ConfigService.WORKSPACE + 'extrarest/update_schedule';
  SKIP_SCHEDULE =  ConfigService.SERVER_ADDRESS + '/api/1.0/' + ConfigService.WORKSPACE + 'extrarest/skip_schedule';
